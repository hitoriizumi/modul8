        ...
        <div class="container">
            <div class="mt-5">
                ...
                @csrf
                    ...
                    <h2>Detail of Video</h2><br>
                    <input type="text" name="description" id="description" cols="30" rows="10" class="form-control" placeholder="insert the detail here">
                    {{-- Message --}}
